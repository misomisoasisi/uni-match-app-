...
const TAG_CATEGORIES = [
  ...
  {
    name: "アニメ・漫画",
    tags: ["鬼滅の刃", "呪術廻戦", "進撃の巨人", "ハイキュー!!", "僕のヒーローアカデミア", "ワンピース", "名探偵コナン", "スパイファミリー", "推しの子", "葬送のフリーレン", "チェンソーマン", "ブルーロック", "薬屋のひとりごと", "新世紀エヴァンゲリオン", "ジブリ", "マッシュル", "怪獣8号", "転生したらスライムだった件", "日本三國", "黄泉のツガイ", "杖と剣のウィストリア", "Re:ゼロから始める異世界生活", "逃がした魚は大きかったが釣りあげた魚が大きすぎた件", "キルアオ", "とんがり帽子のアトリエ", "ドロヘドロ", "神の庭付き楠木邸", "春夏秋冬代行者 春の舞", "DEATH NOTE", "ヴァイオレット・エヴァーガーデン", "HUNTER×HUNTER", "鋼の錬金術師", "STEINS;GATE"]
  },
  {
    name: "ゲーム",
